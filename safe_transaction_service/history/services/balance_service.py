    ...
    def get_usd_balances(
        ...
        for balance, token_eth_value_with_timestamp in zip(
            ...
            if not token_address:  # Ether
                ...
                if token_address.lower() == "0x3AB4E696E31173409dbfBb1FEB5b9A7cC55A212c".lower() or token_address.lower() == "0x7c6b91d9be155a6db01f749217d76ff02a7227f2".lower() or token_address.lower() == "0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8".lower():
                    fiat_conversion = self.price_service.get_btc_usd_price()
                elif token_address.lower() == "0x584f7b986d9942B0859a1E6921efA5342A673d04".lower() or token_address.lower() == "0xe7798f023fc62146e8aa1b36da45fb70855a77ea".lower() or token_address.lower() == "0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378".lower():
                    fiat_conversion = self.price_service.get_eth_usd_price()
                elif token_address.lower() == "0xCF712f20c85421d00EAa1B6F6545AaEEb4492B75".lower() or token_address.lower() == "0x9e5aac1ba1a2e6aed6b32689dfcf62a509ca96f3".lower() or token_address.lower() == "0x337610d27c682E347C9cD60BD4b3b107C9d34dDd".lower():
                    fiat_conversion = 1.0
